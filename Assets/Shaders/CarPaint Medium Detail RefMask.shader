...
Shader "RedDotGames/Mobile/Car Paint Medium Detail Ref Mask" {
   Properties {
	  ...
	  _RefMaskTex("Reflection Mask (black = no reflection)", 2D) = "white" {}  	  
...
void main ()
{
  ...
  tmpvar_18 = xlv_TEXCOORD3.xy;
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_RefMaskTex, tmpvar_18);
  gl_FragData[0] = ((tmpvar_17 + (reflTex * tmpvar_19.x)) + ((tmpvar_16 * reflTex) * tmpvar_19.x));
}
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 57 to 57, TEX: 3 to 3
...
TEMP R5;
TEMP R6;
TEX R5.x, fragment.texcoord[3], texture[2], 2D;
...
MUL R0.xyz, R3, R0.x;
MAD R2.xyz, -R0, c[11].x, fragment.texcoord[4];
ABS R3.w, -c[2];
DP3 R1.w, c[2], c[2];
RSQ R1.w, R1.w;
...
ABS R3.w, R3;
CMP R3.w, -R3, c[11].z, c[11].y;
MUL R5.yzw, R1.w, c[2].xxyz;
CMP R6.xyz, -R3.w, R6, R5.yzww;
DP3 R1.w, R3, R6;
MUL R3.xyz, R3, -R1.w;
MUL R4.xyz, R4.w, R4;
MAD R3.xyz, -R3, c[11].x, -R6;
DP3 R3.x, R3, R4;
MAX R3.x, R3, c[11].z;
POW R4.w, R3.x, c[6].x;
CMP R3.x, -R3.w, R2.w, c[11].y;
SLT R2.w, R1, c[11].z;
MUL R3.xyz, R3.x, c[10];
MUL R4.xyz, R3, c[5];
ABS R2.w, R2;
DP3 R3.w, R2, fragment.texcoord[1];
MUL R4.xyz, R4, R4.w;
CMP R2.w, -R2, c[11].z, c[11].y;
MUL R3.xyz, R3, c[3];
TEX R0, R2, texture[1], CUBE;
CMP R2.xyz, -R2.w, R4, c[11].z;
ABS_SAT R2.w, R3;
ADD R3.w, -R2, c[11].y;
MAX R2.w, R1, c[11].z;
POW R1.w, R3.w, c[9].x;
...
mov_pp r1.w, r4
mad_pp r2, r1, r10.x, r2
mul_pp r0, r0.x, r1
mad_pp r0, r0, r10.x, r2
mov_pp oC0, r0
"
}
