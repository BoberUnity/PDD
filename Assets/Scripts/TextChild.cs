...
public class TextChild : MonoBehaviour
{
    ...
    [SerializeField] private UISprite spriteA = null;
    [SerializeField] private UISprite spriteB = null;
    [SerializeField] private UISprite spriteC = null;
    [SerializeField] private UISprite spriteD = null;
    ...
    public void ButtonsActivate(bool value)
    {
        if (value)
        {
            ...
            spriteA.GetComponent<TweenColor>().to = Color.white;
            labelA.transform.parent.GetComponent<UIButton>().defaultColor = Color.white;

            spriteB.GetComponent<TweenColor>().to = Color.white;
            labelB.transform.parent.GetComponent<UIButton>().defaultColor = Color.white;

            if (spriteC.GetComponent<TweenColor>() != null)
                spriteC.GetComponent<TweenColor>().to = Color.white;
            labelC.transform.parent.GetComponent<UIButton>().defaultColor = Color.white;

            if (spriteD.GetComponent<TweenColor>() != null)
                spriteD.GetComponent<TweenColor>().to = Color.white;
